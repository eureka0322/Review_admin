<div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="deleteModalExample"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">Select "Delete" below if you want to delete Review!.</div>
            <div class="modal-footer">
                ...
                <form id="review-delete-form" method="POST" action="{{ route('review.destroy', ['review' => $review->id]) }}">
                    @csrf
                    @method('DELETE')
                </form>
            </div>
